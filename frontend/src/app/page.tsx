...
export default function VirtualOfficeBright() {
  ...
  const commanderActions = [
    ...
    { id: 'NAV_ASSET_ALLOCATION', label: '생산성 컴퓨팅 자산 배치', icon: Server, category: 'NAVIGATION' },
